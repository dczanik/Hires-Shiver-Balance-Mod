...
#define SHIELD_DEFENSE			(1 << 6)
#define IMMEDIATE_WEAPON		(1 << 7)
#define CREW_IMMUNE				(1 << 8)
<<<<<<<
#define FIRES_FORE				(1 << 9)
#define FIRES_RIGHT				(1 << 10)
#define FIRES_AFT				(1 << 11)
#define FIRES_LEFT				(1 << 12)
#define DONT_CHASE				(1 << 13)
#define PLAYER_CAPTAIN			(1 << 14)
=======
#define RACES_PER_PLAYER 7
#define MAX_SHIPS_PER_SIDE 14
...
#define SPECIAL                (1 << 4)
#define DOWN    			   (1 << 5)
#define LOW_ON_ENERGY          (1 << 6)
#define SHIP_BEYOND_MAX_SPEED  (1 << 7)
#define SHIP_AT_MAX_SPEED      (1 << 8)
#define SHIP_IN_GRAVITY_WELL   (1 << 9)
#define PLAY_VICTORY_DITTY     (1 << 10)
