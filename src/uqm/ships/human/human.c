...
#define MIN_MISSILE_SPEED 40
#define MAX_MISSILE_SPEED 80
#define MISSILE_SPEED (MAX_THRUST >= MIN_MISSILE_SPEED ? MAX_THRUST : MIN_MISSILE_SPEED)
#define THRUST_SCALE 4
