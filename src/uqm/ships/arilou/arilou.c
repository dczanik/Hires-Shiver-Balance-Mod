...
#define ARILOU_OFFSET_2XRES (ARILOU_OFFSET << 1)
#define ARILOU_OFFSET_4XRES (ARILOU_OFFSET << 2)
#define LASER_RANGE DISPLAY_TO_WORLD (88 + ARILOU_OFFSET)
#define LASER_RANGE_2XRES DISPLAY_TO_WORLD (200 + ARILOU_OFFSET_2XRES)
#define LASER_RANGE_4XRES DISPLAY_TO_WORLD (400 + ARILOU_OFFSET_4XRES)
...
#define PERSONAL_SPACE_BUBBLE		DISPLAY_TO_WORLD (400 << RESOLUTION_FACTOR)
#define HOP_DISTANCE			DISPLAY_TO_WORLD (240 << RESOLUTION_FACTOR)
#define HOP_VARIATION			DISPLAY_TO_WORLD (60 << RESOLUTION_FACTOR)
...
initialize_autoaim_laser (ELEMENT *ShipPtr, HELEMENT LaserArray[])
{
	...
	LaserBlock.ex = COSINE (FACING_TO_ANGLE (LaserBlock.face), (LASER_RANGE << RESOLUTION_FACTOR));
	LaserBlock.ey = SINE (FACING_TO_ANGLE (LaserBlock.face), (LASER_RANGE << RESOLUTION_FACTOR));
	LaserBlock.sender = ShipPtr->playerNr;
	LaserBlock.flags = IGNORE_SIMILAR;
	LaserBlock.pixoffs = (ARILOU_OFFSET << RESOLUTION_FACTOR);
