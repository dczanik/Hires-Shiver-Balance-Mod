...
#define JUMP_DIST (120 << RESOLUTION_FACTOR)
...
static void
cone_collision (ELEMENT *ElementPtr0, POINT *pPt0, ELEMENT *ElementPtr1, POINT *pPt1)
{
	...
	else
	{
				...
				&& StarShipPtr->RaceDescPtr->ship_info.energy_level > 0)
		{
			...
			if (StarShipPtr->auxiliary_counter == 0)
			{
				...
				StarShipPtr->auxiliary_counter = 5;
			}
...
static void
umgah_intelligence (ELEMENT *ShipPtr, EVALUATE_DESC *ObjectsOfConcern, COUNT ConcernCounter)
{
