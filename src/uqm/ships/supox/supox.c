...
#define SUPOX_OFFSET (23 << RESOLUTION_FACTOR)
#define MISSILE_OFFSET (2 << RESOLUTION_FACTOR)
...
init_supox (void)
{
	...
	else if (RESOLUTION_FACTOR == 1)
	{
		...
		supox_desc_2xres.init_weapon_func = initialize_gob;
	...
	else
	{
		...
		supox_desc_4xres.init_weapon_func = initialize_gob;
